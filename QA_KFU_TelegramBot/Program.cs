...
namespace QA_KFU_TelegramBot
{
   ...
   "Email: followaida@gmail.com";
           ...
           "\n" +
           "\n Что стоит брать с собой в ДУ?" +
           "\n     Ванная: " +
           "\nПолотенце" +
           "\nПолотенце для рук/ лица" +
           "\nПодставка для щеток" +
           "\nМыльница / жидкое мыло" +
           "\nВедро мусорное" +
           ...
           "\nПолотенце кухонное" +
           "\nТряпка для стола" +
           "\nГубка для мытья посуды / средство для посуды" +
           "\nСкатерть на стол и все поверхности" +
           "\nЯщик для хранения" +
           "\n" +
           "\n     В комнату:" +
           "\nШвабра + тряпка для пола" +
           "\nТапочки" +
           "\nСовок" +
           "\nСушилка для вещей , утюг" +
           "\nАптечка" +
           "\nУдлинитель" +
           "\nВешалки" +
           "\nЛожка для обуви" +
